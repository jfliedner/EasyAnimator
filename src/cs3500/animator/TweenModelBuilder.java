...
public interface TweenModelBuilder<IAnimator> {
   ...
   */
  TweenModelBuilder<IAnimator> addOval(
          String name,
          float cx, float cy,
   ...
   * @return the builder object
   */
  TweenModelBuilder<IAnimator> addRectangle(
          String name,
          float lx, float ly,
   ...
   */
  TweenModelBuilder<IAnimator> addMove(
          String name,
   ...
   */
  TweenModelBuilder<IAnimator> addColorChange(
          String name,
   ...
   */
  TweenModelBuilder<IAnimator> addScaleToChange(String name, float fromSx, float
